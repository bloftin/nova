...
#  3. Copy and paste the objects you want into an All_objects.txt file, remove any lines that are not objects
#     Important so far only tested with NGC/PGC/SDSS objects others may vary depending on NED search return
